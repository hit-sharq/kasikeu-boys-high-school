/*
  ...
  - Added the required column `creatorId` to the `CalendarEvent` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "CalendarEvent" ADD COLUMN     "creatorId" TEXT NOT NULL;
